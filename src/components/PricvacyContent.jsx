...
const PricvacyContent = () => {
  return (
    <Box
    flex={5}
    sx={{ height: '100%', padding : "20px 50px" }}>
      <Box>
        <Typography variant="body1" color="text.secondary">
             ClayApps[Rohan.Dsouza] built the Bible app as a Free app. This SERVICE is provided by ClayApps[Rohan.Dsouza] at no cost and is intended for use as is.
        </Typography>
        <Typography variant="body1" color="text.secondary">
        ...
        <Typography variant="body1" color="text.secondary">
          ...
          at Bible unless otherwise defined in this Privacy Policy.
        </Typography>
        ...
        <Typography variant="body1" color="text.secondary">
          ...
          personally identifiable information, including but not limited to Anonymous analytics data,Or App content,. The information that I request will be retained on your device and is not collected by me in any way.
        </Typography>
        <Typography variant="body1" color="text.secondary">
...
export default PricvacyContent
